      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="relative h-[500px] rounded-xl overflow-hidden shadow-2xl">
            ...
            <Image
              src="/images/services/calib.jpeg"
              alt="Étalonnage de Balances"
              fill
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold text-primary-900">
                Service d'Étalonnage Professionnel
              </h2>
              <div className="prose prose-lg text-secondary-600">
                <p>
                  Nous proposons des services professionnels d'étalonnage de balances pour garantir la précision et la conformité de vos instruments de pesage. Grâce à notre expertise et à nos équipements certifiés, nous assurons un étalonnage conforme aux normes en vigueur.
                </p>
                <p>
                  Notre service s'adapte aux secteurs industriels, commerciaux et laboratoires. Faites confiance à notre savoir-faire pour maintenir la fiabilité de vos mesures.
                </p>
              </div>
            </div>
